...
typedef struct simulationMonitor
{
 ...
 double speed, speedDecision, speedDecisionInputs, speedDecisionThink, speedActionTurn, speedAction, speedGrow, speedMove, speedAttack, speedReplicate, speedSeed, speedIntelTests;
